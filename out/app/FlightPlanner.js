...
export class TripPlanner {
    ...
    initAllAirports(data) {
        data.airports.forEach(airport => {
            ...
            this.graph.addNode(airport.code, new Airport(airport.code, airport.latitudeDegrees, airport.latitudeMinutes, airport.longitudeDegrees, airport.longitudeMinutes));
        });
